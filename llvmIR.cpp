...
Function *PrototypeAST::Codegen() {
    ...
    Function *F = Function::Create(FT, Function::ExteralLinkage, Name, TheModule);
    ...
    unsigned Idx = 0;
    for(Funtion::arg_iterator AI = F->arg_begin(); Idx != Args.size(); ++AI, ++Idx) {
        AI->setName(Args[Idx]);
...
Function *FunctionAST::Codegen() {
    ...
    Funciotn *THeFunction = Proto->Codegen();
...
int main() {
    ...
    TheModule = new Module("IZAY01 cool jit", Context);
